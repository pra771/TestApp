...
import com.example.dogsafityapp.databinding.ActivitySideNavigationBinding;
...
public class SideNavigation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarSideNavigation.toolbar.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow,R.id.AboutUs,R.id.termsandconditions)
